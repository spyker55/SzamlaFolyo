...
export default async function PartnerPage({
  ...
  const [
    ...
    events,
      ...
      supabase
        ...
        .order("name")
        .limit(1000),
      // Master data is the kind of thing that quietly drifts — a bank account
      // corrected, an adószám "fixed" — so this screen shows what was changed
      // and by whom.
      fetchAuditEvents(supabase, { entityType: "partner", entityId: partnerId, limit: 100 }),
    ]);
  ...
  return (
    <div className="space-y-5">
      ...
      <AuditCard
        events={events}
        empty="Ehhez a partnerhez még nincs naplóbejegyzés — a napló később indult, mint a partner."
      />
    </div>
  );
}
